...
public class Logistic implements Scramble {
    public Logistic() {
    }
    ...
    public static BufferedImage scrambling(BufferedImage srcImage, int period) {

        double x = 0.1, u = 4;
        for (int i = 1; i <= 500; i++)
            x = x * u * (1 - x);

        BufferedImage src_image = srcImage, res_image = null;
